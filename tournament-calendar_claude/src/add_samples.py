...
def add_real_working_samples():
    ...
    samples = [
        {
            ...
            'end_date': '2024-11-20',
            'official_url': 'https://www.icc-cricket.com',  # REAL working URL
        ...
        },
        {
            ...
            'end_date': '2024-12-31',
            'official_url': 'https://www.fifa.com',  # REAL FIFA website
        ...
        },
        {
            ...
            'end_date': '2025-03-17',
            'official_url': 'https://www.bwfworldtour.bwfbadminton.com',  # REAL BWF site
        ...
        },
        {
            ...
            'end_date': '2025-01-19',
            'official_url': 'https://www.tatamumbaimarathon.com',  # REAL Mumbai Marathon site
        ...
        },
        {
            ...
            'end_date': '2024-12-15',
            'official_url': 'https://www.prokabaddi.com',  # REAL PKL website
        ...
        },
        {
            ...
            'end_date': '2025-02-15',
            'official_url': 'https://www.swimming.org.in',  # Swimming Federation of India
        ...
        },
        {
            ...
            'start_date': '2024-10-15',
            'end_date': '2025-04-15',
            'official_url': 'https://www.nba.com',  # REAL NBA website
        ...
        },
        {
            ...
            'end_date': '2024-12-28',
            'official_url': 'https://www.fide.com',  # REAL FIDE website
        ...
        },
        {
            ...
            'end_date': '2024-08-08',
            'official_url': 'https://www.ittf.com',  # REAL ITTF website
        ...
        },
        {
            ...
            'end_date': '2025-06-21',
            'official_url': 'https://www.un.org/en/observances/yoga-day',  # REAL UN page
        ...
        },
        {
            ...
            'end_date': '2024-12-25',
            'official_url': 'https://www.tcs.com',  # REAL TCS website
        ...
        },
        {
            ...
            'end_date': '2025-07-27',
            'official_url': 'https://www.letour.fr/en',  # REAL Tour de France site
        ...
        },
        {
            ...
            'end_date': '2024-11-17',
            'official_url': 'https://www.ifbb.com',  # REAL IFBB website
    ...
    # Test URLs (optional - uncomment to verify)
    # print("\n🔗 Testing URLs...")
    # import requests
    # for tournament in samples[:3]:  # Test first 3
    #     try:
    #         response = requests.head(tournament['official_url'], timeout=5)
    #         status = "✅ Working" if response.status_code < 400 else f"❌ Error {response.status_code}"
    #         print(f"{tournament['name']}: {status}")
    #     except Exception as e:
    #         print(f"{tournament['name']}: ❌ Failed - {str(e)[:50]}")
